  ...
  <script>
    ...
    geocoderControl.on('result', function(destination) {
      ...
      routeChargers.features.forEach( chargeLocation => {
        ...
        routeChargerList += `<p><strong><table border="0" width="100%"><tr><td align="left">${chargeLocation.properties.distance}</td><td align="center">${chargeLocation.properties.duration}</td>`;
        routeChargerList += `<td align="right">${chargeLocation.properties.range ? chargeLocation.properties.range : ""}</td></tr></table></strong><br>`;
