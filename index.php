  ...
  <script>
    ...
    geocoderControl.on('result', function(destination) {
      ...
      routeChargers.features.forEach( chargeLocation => {
        ...
        routeChargerList += `<a onlick="flyToCharger(${chargeLocation.properties.coordinates.lng},${chargeLocation.properties.coordinates.lat},${chargeLocation.properties.name},${chargeLocation.properties.city});"><strong>${chargeLocation.properties.distance} ${chargeLocation.properties.duration} ${chargeLocation.properties.range ? chargeLocation.properties.range : ""}</strong><br>`;
