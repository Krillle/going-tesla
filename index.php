...
<body>
  ...
      var value = "; " + document.cookie;
    ...
    function updateRouteChargerList(destination) {
      ...
      routeChargerList += `<div class="onecolumn"><a class="popupbutton" href="#" style="width: 275px;" onclick="cancelRouteChargerList(); return false;">Abbrechen</a>`;
      routeChargerList += `<a class="popupbutton popupbutton-icon-highwayCharger" style="margin-left: 25px; width: 60px;" href="#" onclick="toggleeRouteList(); return false;"></a></div>`;
