...
<head>
  ...
  <meta property="og:url" content="https://goingtesla.mycaptain.cloud/">
  ...
  <meta property="og:image" content="https://goingtesla.mycaptain.cloud/lib/goingtesla.png">

  <!-- Twitter -->
  <meta property="twitter:card" content="summary_large_image">
  <meta property="twitter:url" content="https://goingtesla.mycaptain.cloud/">
  ...
      var value = "; " + document.cookie;
    ...
    function chargeLocationDetails(chargeLocation,includeDistance) {
      ...
      return {
        ...
        "properties": {
          ...
          "delayRaw" : includeDistance ? delayRaw : false,
    ...
    function postProcessSegments() {
      ...
      routeChargers.features.forEach( chargeLocation => {
        ...
        routeChargerList += `<div style="position: relative; padding-left: ${iconColumnWidth}px;${chargeLocation.properties.rangeRaw < 0 || chargeLocation.properties.delayRaw > 360 ? ' opacity: 0.5;' : ''}">`;
