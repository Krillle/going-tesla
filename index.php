  ...
  <script>
    ...
    geocoderControl.on('result', function(destination) {
      ...
      routeChargers.features.forEach( chargeLocation => {
        ...
        routeChargerList += `<p><table border="0" width="100%"><tr><td align="left"><strong>${chargeLocation.properties.distance}</strong></td><td align="center"><strong>${chargeLocation.properties.duration}</strong></td>`;
        routeChargerList += `<td align="right"><strong>${chargeLocation.properties.range ? chargeLocation.properties.range : ""}</strong></td></tr></table>`;
